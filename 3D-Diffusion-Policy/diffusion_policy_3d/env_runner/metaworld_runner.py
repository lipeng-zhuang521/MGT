...
class MetaworldRunner(BaseRunner):
    ...
    def run(self, policy: BasePolicy, save_video=False):
        ...
        local_video_path = os.path.join("/home/lipeng/Downloads/Lipeng_human_demonstration_icra/3D-Diffusion-Policy-master-MGT/3D-Diffusion-Policy/data/outputs/video/metaworld_soccer-bskA-soccerB-latent.mp4")
